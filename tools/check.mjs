...
if (!homepage.includes('id="blueprints"') || !homepage.includes('/media/docs/images/blueprint-editor.jpg')) errors.push('Homepage is missing the real Blueprint editor showcase');
