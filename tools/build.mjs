...
const blueprintShowcase = `<section id="blueprints" class="section wrap"><div class="section-heading"><div><p class="eyebrow">BLUEPRINTS / NATIVE GAMEPLAY</p><h2>Wire the logic.<br>Keep it native.</h2></div><p>Visual classes, typed connections and reusable entity templates.<br>Compiled C++ for the same PlayStation runtime.</p></div><figure class="editor-shot"><div class="window-bar"><span>UniQo Blueprint Editor</span><span class="live-label">REAL EDITOR CAPTURE</span></div><a href="/media/docs/images/blueprint-editor.jpg" aria-label="Open the full-size Blueprint editor screenshot"><img src="/media/docs/images/blueprint-editor.jpg" width="1583" height="949" alt="UniQo Blueprint editor with its Components tree, My Blueprint panel, connected gameplay nodes and Details inspector" loading="lazy"></a><figcaption><span>Build events with typed pins, inspect class defaults, and navigate the graph.</span><a class="text-link" href="/docs/blueprints/">Explore Blueprints ${arrow}</a></figcaption></figure><div class="tags" aria-label="Blueprint capabilities"><a href="/docs/blueprints/#inheritance-and-identity">C++ / Blueprint inheritance</a><a href="/docs/blueprints/#execution-and-types">Typed visual scripting</a><a href="/docs/blueprints/#entity-templates-and-construction">Reusable entity templates</a><a href="/docs/blueprints/#debugging-and-iteration">Node breakpoints &amp; stepping</a></div><p class="small muted blueprint-platform">Blueprint reflection and authoring currently require Windows x64. General macOS editor support does not yet include the Blueprint toolchain.</p></section>`;
...
write('index.html', page('UniQo — Build games for the original PlayStation', 'A standalone visual editor and native PSX runtime. Build worlds and create gameplay with Blueprints or C++ for the original PlayStation.', '/', homeWithBlueprints));
const searchItems = [];
