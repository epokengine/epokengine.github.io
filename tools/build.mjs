...
const groups = [
  ['Start here', [['getting-started', 'Getting started'], ['features', 'Complete feature catalog'], ['release-v0.2.0', "What's new in v0.2.0"], ['projects', 'Projects'], ['editor', 'The editor'], ['content-browser', 'Content Browser'], ['settings', 'Settings'], ['formats', 'File formats & migration']]],
  ['Create your world', [['blockout', 'Blockout modeling'], ['third-person', 'Third Person template'], ['worlds-2d', '2D worlds, 3D worlds & UI'], ['static-mesh-import', 'Importing models'], ['skeletal', 'Skeletal characters'], ['textures', 'Textures']]],
  ['Render & animate', [['lighting', 'Lighting & shadows'], ['environment-effects', 'Environment effects'], ['palette-animation', 'Palette animation']]],
  ['Build gameplay', [['actors', 'Actors & Components'], ['migration-actors', 'Existing projects & Actors'], ['scene-blueprints', 'Scene Blueprints'], ['blueprints-tutorial', 'Your first Blueprint'], ['blueprints', 'Blueprint reference'], ['lua-tutorial', 'Your first Lua class'], ['lua-scripting', 'Lua scripting reference'], ['scripting', 'C++ scripting'], ['input-collision', 'Input & collision'], ['runtime-services', 'Runtime services'], ['camera-resources', 'Cameras'], ['resources', 'Shared resources'], ['memory-card', 'Memory Card']]],
  ...
  ['Sound & interface', [['music-sequences', 'Audio playback & MIDI music'], ['assets', 'Assets & audio'], ['hud', 'HUD & UI'], ['native-hud-preview', 'Procedural UI preview']]],
  ['Build, run & ship', [['iteration', 'Build, measure & iterate'], ['play', 'Play targets & loading'], ['performance', 'Performance'], ['streaming', 'Geometry streaming'], ['runtime', 'Standalone runtime'], ['release-process', 'Release process']]],
  ['Extend & understand', [['lua-vm-runtime', 'Lua VM runtime'], ['mcp', 'AI / MCP'], ['architecture', 'Architecture'], ['testing', 'Testing'], ['demo', '2.5D example']]],
