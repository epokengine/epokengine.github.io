...
const groups = [
  ...
  ['Release notes', [['release-v0.4.0', 'v0.4.0 — Terrain, navigation & Native PC'], ['release-v0.3.0', 'v0.3.0 — Gameplay API, sequencer & Epok Pulse'], ['release-v0.2.0', 'v0.2.0 — Lua gameplay & skeletal playback'], ['release-v0.1.1', 'v0.1.1 — Typed Actors & progressive output']]],
...
const special = { architecture: 'knowledge/architecture.md', resources: 'knowledge/maintainers/resources.md', testing: 'knowledge/maintainers/testing.md', runtime: 'runtime/README.md', 'release-v0.4.0': 'docs/releases/v0.4.0.md', 'release-v0.3.0': 'docs/releases/v0.3.0.md', 'release-v0.2.0': 'docs/releases/v0.2.0.md', 'release-v0.1.1': 'docs/releases/v0.1.1.md', api: 'docs/api/index.md', 'api/epok': 'docs/api/epok.md', 'api/psyqo': 'docs/api/psyqo.md', license: 'LICENSE', credits: 'THIRD_PARTY_NOTICES.md', 'runtime-credits': 'runtime/THIRD_PARTY_NOTICES.md' };
