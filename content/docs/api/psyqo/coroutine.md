...
**Returns.** Returns `std::suspend_always`. Check the purpose and failure notes before using the value.
...
**Returns.** Returns `Coroutine<>`. Check the purpose and failure notes before using the value.
