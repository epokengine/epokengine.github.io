# PsyQo API: Primitives

> **Header:** `"psyqo/primitives.hh"` · **Tier:** Pinned PsyQo API · **Source:** [open header](https://github.com/pcsx-redux/nugget/blob/6186b131aacc5853a9161fb076ed34ffe504552d/psyqo/primitives.hh)

This module covers typed PlayStation GPU primitives. It documents 0 public callables declared directly in this header.
