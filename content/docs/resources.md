...
When adding an icon, regenerate from the original full font, not from the existing subset. The maintenance script requires fonttools 4.60.1, which is not needed to build or run UniQo:
